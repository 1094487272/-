    ...
    function renderUI(data) {
        let tmp = data.goods.map(item => {
            ...
            <ul class="order_lists order_item" gid=${item.good_id}>
                ...
                <li class="list_con">
                  <div class="list_img"><a href="./detail.html?product/${item.good_id}"><img src=${item.img} alt=""></a></div>
                  <div class="list_text"><a href="./detail.html?product/${item.good_id}">${item.title}</a></div>
                </li>
                <li class="list_price">
                  <p class="price">￥${item.priceA}</p>
                </li>
                ...
                <li class="list_sum">
                  <p class="sum_price" data-price=${item.priceA}>￥${Math.round(item.priceA * item.num * 100) / 100}</p>
                </li>
                <li class="list_op">
